...
import com.weixuan.shenxin.data.LyricObject;
...
public class LyricView extends View{
	...
	private  float SIZEWORD=32;//显示歌词文字的大小值
	...
	public void setTextSize(){
		SIZEWORD=getResources().getDimension(R.dimen.font_size_16);
	}
...
//		}
	...
	/**
	 * 读取歌词文件
	 * @param fileName 歌词的路径
	 * 
	 */
	public void setRawId(String  fileName) {
		TreeMap<Integer, LyricObject> lrc_read =new TreeMap<Integer, LyricObject>();
		String data = "";
		try {
		  blLrc=true;
		  AssetFileDescriptor fileDescriptor=getResources().getAssets().openFd(fileName);
