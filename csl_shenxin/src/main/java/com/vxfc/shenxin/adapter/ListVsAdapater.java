...
public class ListVsAdapater extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (Team.ShenXin.id.equals(gameTeam.getTeamAId())){
            holder.view_home.setVisibility(View.VISIBLE);
            holder.view_home.setBackgroundResource(Team.getScore(gameTeam.getRes(), true));
        }else {
            holder.view_visiting.setVisibility(View.VISIBLE);
            holder.view_visiting.setBackgroundResource(Team.getScore(gameTeam.getRes(), false));
        }
        return convertView;
    }
